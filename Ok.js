...
async function initializeGame() {
    ...
    // Show a welcome message that automatically closes and has no button.
    showMessage("Welcome to Himalayan Royals!", "Himalayan Royals is a platform to earn Robux by watching ads.", false, 3000);
